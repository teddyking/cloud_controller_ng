          ...
          describe 'metric_tags' do
            ...
            before do
              AppLabelModel.create(
                app: app_model,
                key_prefix: 'metric.tag.cloudfoundry.org',
            ...
            context 'when cc.custom_metric_tags is enabled' do
              before do
                TestConfig.override(custom_metric_tags: true)
              end
            ...
            context 'when cc.custom_metric_tags is disabled' do
              before do
                TestConfig.override(custom_metric_tags: false)
              end
